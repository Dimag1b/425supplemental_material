...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ItemStock.stock_status'
        db.add_column(u'cleartherack_itemstock', 'stock_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ItemStock.in_stock'
        db.add_column(u'cleartherack_itemstock', 'in_stock',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ItemStock.stock_status'
        db.delete_column(u'cleartherack_itemstock', 'stock_status')
